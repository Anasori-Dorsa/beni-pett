...
const dict = {
  fa: {
    ...
    nav_offers: "تخفیف‌ها",
    offers_title: "تخفیف‌های ویژه",
    offers_sub: "منتخب محصولات با بهترین قیمت — تا تمام نشدن موجودی.",
    offers_eye: "پیشنهاد شگفت‌انگیز",
    offers_empty: "در حال حاضر محصول تخفیف‌داری موجود نیست.",
    view_offers: "مشاهده همه تخفیف‌ها",
    sale_badge: "تخفیف",
    payment_redirect: "در حال انتقال به درگاه پرداخت…",
    payment_failed: "پرداخت ناموفق بود",
    payment_success: "پرداخت با موفقیت انجام شد",
    ref_number: "شماره پیگیری",
  },
  en: {
    brand: "Beni Pett",
    ...
    offers_sub: "Hand-picked deals — while stocks last.",
    offers_eye: "Limited-time deal",
    offers_empty: "No offers available right now.",
    view_offers: "See all offers",
    sale_badge: "SALE",
